...
<?php
    ...
    $consulta_frutas = "SELECT  PRO_NOME, PRO_CODIGO, PRO_DESCRICAO, PRO_UNIDADE, PRO_IMAGEM, PRO_VALOR, CAT_CODIGO ";
    $consulta_frutas .= " FROM produto ";
    $consulta_frutas .= " WHERE CAT_CODIGO = 2 ";
    if( isset($_GET["produto"])) {
      $nome_produto = $_GET["produto"];
      $consulta_frutas .= " AND PRO_NOME LIKE '%{$nome_produto}%' ";
    }

    $frutas = mysqli_query($conecta,$consulta_frutas);
    if( !$frutas){
...
<html lang="pt-br">
  ...
  <body>
      ...
      <nav class="nav fixed-top navbar-expand-lg navbar-dark nav" style="background-color: #467302;">
        <div id="area-cabecalho" class="container-fluid">
          ...
          <div class=" mx-auto pt-3">
            <form action="frutas.php" method="get" class="form-ij nline col-lg-offset-7">
    ...
    <div id="area-principal3" class="container">
        ...
        <!--abertura postagem-->
           <h2 class="p-2" style="text-align: center;">Frutas</h2>

            
            <?php include_once("../php/funcoes.php")?>
        <?php
            while( $registro = mysqli_fetch_assoc($frutas)){
        ?>    
